...
for i in range(1, 7):
    ...
    net = cv2.dnn.readNetFromCaffe("E:\Internship\sparks foundation\Task_1\MobileNetSSD_deploy.prototxt.txt",
                                   "E:\Internship\sparks foundation\Task_1\MobileNetSSD_deploy.caffemodel")
